...
export const getV1AdminCustomersByBillingAccountByBillingAccountIdResponse200Schema = z.object({
	success: z.literal(true),
	data: z.object({
		customer: z.object({
			id: z.string(),
...
export const getV1AdminCustomersByCustomerIdPurchasesResponse200Schema = z.object({
	success: z.literal(true),
	data: z.array(
		z.object({
			id: z.string(),
...
export const getV1AdminCustomersByCustomerIdSubscriptionsResponse200Schema = z.object({
	success: z.literal(true),
	data: z.array(
		z.object({
			id: z.string(),
...
export const getV1AdminCustomersByCustomerIdStoreEventsResponse200Schema = z.object({
	success: z.literal(true),
	data: z.array(
		z.object({
			id: z.string(),
...
export const getV1AdminCustomersByCustomerIdProjectionJobsResponse200Schema = z.object({
	success: z.literal(true),
	data: z.array(
		z.object({
			id: z.string(),
...
export const getV1AdminCustomersByCustomerIdResponse200Schema = z.object({
	success: z.literal(true),
	data: z.object({
		customer: z.object({
			id: z.string(),
...
export const getV1AdminPurchasesResponse200Schema = z.object({
	success: z.literal(true),
	data: z.array(
		z.object({
			id: z.string(),
...
export const getV1AdminSubscriptionsResponse200Schema = z.object({
	success: z.literal(true),
	data: z.array(
		z.object({
			id: z.string(),
...
export const getV1AdminStoreEventsResponse200Schema = z.object({
	success: z.literal(true),
	data: z.array(
		z.object({
			id: z.string(),
...
export const getV1AdminStoreEventsByEventIdResponse200Schema = z.object({
	success: z.literal(true),
	data: z.object({
		id: z.string(),
		provider: z.enum(billingProviderValues("google")),
...
export const getV1AdminProjectionJobsResponse200Schema = z.object({
	success: z.literal(true),
	data: z.array(
		z.object({
			id: z.string(),
...
export const getV1AdminCatalogProductsResponse200Schema = z.object({
	success: z.literal(true),
	data: z.array(
		z.object({
			id: z.string(),
...
export const getV1AdminStatsSummaryResponse200Schema = z.object({
	success: z.literal(true),
	data: z.object({
...
export const getV1AdminCatalogStoreProductsResponse200Schema = z.object({
	success: z.literal(true),
	data: z.array(
		z.object({
			id: z.string(),
...
export const postV1AdminStoreEventsByEventIdReplayResponse200Schema = z.object({
	success: z.literal(true),
	data: z.object({
		eventId: z.string(),
...
export const postV1AdminReconciliationSubscriptionsRunResponse200Schema = z.object({
	success: z.literal(true),
	data: z.object({
