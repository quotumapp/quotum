...
export const postV1BillingAccountsByBillingAccountIdUsageCheckResponse200Schema = z.object({
	success: z.literal(true),
	data: z.object({
		allowed: z.boolean(),
		reason: z.enum([
...
export const postV1BillingAccountsByBillingAccountIdUsageConsumeResponse200Schema = z.object({
	success: z.literal(true),
	data: z.object({
		usageEventId: z.union([z.null(), z.string()]),
		recordedAt: z.union([z.null(), z.string()]),
